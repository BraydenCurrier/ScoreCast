...
from nfl import nfl_logos  # Import your generated logo database
...
logo_keys = [key for key in dir(nfl_logos) if key.startswith("LOGO_")]
...
print(f"Loaded {len(logo_keys)} NFL team logos for testing.")
print("Commands:")
print("  n = next logo")
...
try:
    while running:
        ...
        logo_data = getattr(nfl_logos, current_key)
